...
let flag1= false;
    ...
    document.getElementById("online_courses").addEventListener("click", function(){
        window.location.href= "./online.html";
    });
    document.getElementById("certifications").addEventListener("click", function(){
        window.location.href= "./certificate.html";
    });
    document.getElementById("live_training").addEventListener("click", function(){
        window.location.href= "./LiveTranining.html";
    });
    document.getElementById("remote_working").addEventListener("click", function(){
        window.location.href= "./index.html";
    });